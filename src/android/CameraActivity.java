...
public class CameraActivity extends Fragment {
  ...
  PictureCallback jpegPictureCallback = new PictureCallback(){
    public void onPictureTaken(byte[] data, Camera arg1){
      ...
      try {
        ...
        System.out.println("Total time for jpegencode... " + (System.currentTimeMillis() - before));
        canTakePicture = true;
        //mCamera.startPreview();
      }
    }
  ...
  public void takePicture(final int width, final int height, final int quality){
    ...
    System.out.println("takePicture just called...");
    final long before = System.currentTimeMillis();
    ...
    if(mPreview != null) {
      ...
      new Thread() {
        public void run() {
          ...
          System.out.println("Total time before we call native takePicture... " + (System.currentTimeMillis() - before));

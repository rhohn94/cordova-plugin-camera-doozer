...
public class CameraPreview extends CordovaPlugin implements CameraActivity.CameraPreviewListener {
  ...
  private static final String ON_PREVIEW_TAPPED_CALLBACK = "onPreviewTapped";
  ...
  private CallbackContext tapPreviewCallbackContext;
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    ...
    } else if (ON_PREVIEW_TAPPED_CALLBACK.equals(action)) {
      return setPreviewTappedListener(callbackContext);
    }
    return false;
  }
...
private boolean getSupportedFocusModes(CallbackContext callbackContext) {
  ...
  public boolean setPreviewTappedListener(CallbackContext callbackContext) {
    tapPreviewCallbackContext = callbackContext;
    return true;
  }

  public void onPreviewTapped() {
    if(tapPreviewCallbackContext == null) {
      return;
    }
    PluginResult pluginResult = new PluginResult(PluginResult.Status.OK, "Preview button pressed.");
    tapPreviewCallbackContext.sendPluginResult(pluginResult);
  }
